                                         ...
                                         UINT cchMax)
{
	...
	switch (uFlags) 
   {
	case GCS_HELPTEXT:		// fetch help text for display at the bottom of the 
		...
		{
			case 0:
            strncpy(pszName, "Produce ed2k hash", cchMax);
				break;
			case 1:
            strncpy(pszName, "Produce ed2k HTML links", cchMax);
				break;
			case 2:
            strncpy(pszName, "Produce ed2k hash, recursively", cchMax);
				break;
			case 3:
	...
	case GCS_VERB:			// language-independent command name for the menu item 
		...
		{
			case 0:
            strncpy(pszName, "Hash", cchMax);
				break;
			case 1:
            strncpy(pszName, "HTML hash", cchMax);
				break;
			case 2:
            strncpy(pszName, "Hash recursively", cchMax);
				break;
			case 3:
